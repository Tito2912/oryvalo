...
export const metadata: Metadata = {
  title: 'AI Tools',
  description: 'Practical AI tools and workflows for beginners: create content, produce video, automate tasks, and monetize your skills with a simple, usable stack.',
